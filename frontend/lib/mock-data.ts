...
export const lessonsForModule: Record<string, LessonData[]> = {
  'mod-1': [
    { id: 'l-1-1', moduleId: 'mod-1', number: '1.1', filePrefix: '01', title: 'Introduction', state: 'current', xp: 8 },
    { id: 'l-1-2', moduleId: 'mod-1', number: '1.2', filePrefix: '02', title: 'Roles and Responsibilities of Security Professionals', state: 'upcoming', xp: 10 },
    { id: 'l-1-3', moduleId: 'mod-1', number: '1.3', filePrefix: '03', title: 'Legislation and the Licensing of Security Professionals in Alberta', state: 'upcoming', xp: 12 },
    { id: 'l-1-4', moduleId: 'mod-1', number: '1.4', filePrefix: '04', title: 'Appearance and Conduct for Security Professionals', state: 'upcoming', xp: 10 },
    { id: 'l-1-5', moduleId: 'mod-1', number: '1.5', filePrefix: '05', title: 'Conclusion', state: 'upcoming', xp: 8 },
  ],
  'mod-2': [
    { id: 'l-2-1', moduleId: 'mod-2', number: '2.1', filePrefix: '01', title: 'Introduction', state: 'upcoming', xp: 8 },
    { id: 'l-2-2', moduleId: 'mod-2', number: '2.2', filePrefix: '02', title: 'Charter of Rights and the Criminal Code of Canada', state: 'upcoming', xp: 12 },
    { id: 'l-2-3', moduleId: 'mod-2', number: '2.3', filePrefix: '03', title: 'Use of Force', state: 'upcoming', xp: 12 },
    { id: 'l-2-4', moduleId: 'mod-2', number: '2.4', filePrefix: '04', title: 'Trespass to Premises Act', state: 'upcoming', xp: 10 },
    { id: 'l-2-5', moduleId: 'mod-2', number: '2.5', filePrefix: '05', title: 'Petty Trespass Act', state: 'upcoming', xp: 10 },
    { id: 'l-2-6', moduleId: 'mod-2', number: '2.6', filePrefix: '06', title: 'Conclusion', state: 'upcoming', xp: 8 },
  ],
  'mod-3': [
    { id: 'l-3-1', moduleId: 'mod-3', number: '3.1', filePrefix: '01', title: 'Introduction', state: 'upcoming', xp: 8 },
    { id: 'l-3-2', moduleId: 'mod-3', number: '3.2', filePrefix: '02', title: 'Observation', state: 'upcoming', xp: 10 },
    { id: 'l-3-3', moduleId: 'mod-3', number: '3.3', filePrefix: '03', title: 'Patrol Skills', state: 'upcoming', xp: 10 },
    { id: 'l-3-4', moduleId: 'mod-3', number: '3.4', filePrefix: '04', title: 'Dealing with Substance Abusers', state: 'upcoming', xp: 10 },
    { id: 'l-3-5', moduleId: 'mod-3', number: '3.5', filePrefix: '05', title: 'Interacting with the Media', state: 'upcoming', xp: 10 },
    { id: 'l-3-6', moduleId: 'mod-3', number: '3.6', filePrefix: '06', title: 'Traffic Control', state: 'upcoming', xp: 10 },
    { id: 'l-3-7', moduleId: 'mod-3', number: '3.7', filePrefix: '07', title: 'Staying Safe', state: 'upcoming', xp: 10 },
    { id: 'l-3-8', moduleId: 'mod-3', number: '3.8', filePrefix: '08', title: 'Post Orders', state: 'upcoming', xp: 10 },
    { id: 'l-3-9', moduleId: 'mod-3', number: '3.9', filePrefix: '09', title: 'Starting a Shift', state: 'upcoming', xp: 10 },
    { id: 'l-3-10', moduleId: 'mod-3', number: '3.10', filePrefix: '10', title: 'Ending a Shift', state: 'upcoming', xp: 10 },
    { id: 'l-3-11', moduleId: 'mod-3', number: '3.11', filePrefix: '11', title: 'Working with a Partner', state: 'upcoming', xp: 10 },
    { id: 'l-3-12', moduleId: 'mod-3', number: '3.12', filePrefix: '12', title: 'Use of Force Response', state: 'upcoming', xp: 12 },
    { id: 'l-3-13', moduleId: 'mod-3', number: '3.13', filePrefix: '13', title: 'Conclusion', state: 'upcoming', xp: 8 },
  ],
  'mod-4': [
    { id: 'l-4-1', moduleId: 'mod-4', number: '4.1', filePrefix: '01', title: 'Introduction', state: 'upcoming', xp: 8 },
    { id: 'l-4-2', moduleId: 'mod-4', number: '4.2', filePrefix: '02', title: 'Verbal and Non-Verbal Communication', state: 'upcoming', xp: 10 },
    { id: 'l-4-3', moduleId: 'mod-4', number: '4.3', filePrefix: '03', title: 'Challenges to Communication', state: 'upcoming', xp: 10 },
    { id: 'l-4-4', moduleId: 'mod-4', number: '4.4', filePrefix: '04', title: 'Communicating with Uncooperative Persons', state: 'upcoming', xp: 10 },
    { id: 'l-4-5', moduleId: 'mod-4', number: '4.5', filePrefix: '05', title: 'Conducting an Interview', state: 'upcoming', xp: 10 },
    { id: 'l-4-6', moduleId: 'mod-4', number: '4.6', filePrefix: '06', title: 'Conclusion', state: 'upcoming', xp: 8 },
  ],
  'mod-5': [
    { id: 'l-5-1', moduleId: 'mod-5', number: '5.1', filePrefix: '01', title: 'Introduction', state: 'upcoming', xp: 8 },
    { id: 'l-5-2', moduleId: 'mod-5', number: '5.2', filePrefix: '02', title: 'Notebooks', state: 'upcoming', xp: 10 },
    { id: 'l-5-3', moduleId: 'mod-5', number: '5.3', filePrefix: '03', title: 'Statements', state: 'upcoming', xp: 10 },
    { id: 'l-5-4', moduleId: 'mod-5', number: '5.4', filePrefix: '04', title: 'Reports', state: 'upcoming', xp: 10 },
    { id: 'l-5-5', moduleId: 'mod-5', number: '5.5', filePrefix: '05', title: 'Evidence', state: 'upcoming', xp: 10 },
    { id: 'l-5-6', moduleId: 'mod-5', number: '5.6', filePrefix: '06', title: 'Preparing for Court', state: 'upcoming', xp: 10 },
    { id: 'l-5-7', moduleId: 'mod-5', number: '5.7', filePrefix: '07', title: 'Conclusion', state: 'upcoming', xp: 8 },
  ],
  'mod-6': [
    { id: 'l-6-1', moduleId: 'mod-6', number: '6.1', filePrefix: '01', title: 'Introduction', state: 'upcoming', xp: 8 },
    { id: 'l-6-2', moduleId: 'mod-6', number: '6.2', filePrefix: '02', title: 'Alarm Systems', state: 'upcoming', xp: 10 },
    { id: 'l-6-3', moduleId: 'mod-6', number: '6.3', filePrefix: '03', title: 'Responding to Alarms', state: 'upcoming', xp: 10 },
    { id: 'l-6-4', moduleId: 'mod-6', number: '6.4', filePrefix: '04', title: 'Emergency Scene Management', state: 'upcoming', xp: 12 },
    { id: 'l-6-5', moduleId: 'mod-6', number: '6.5', filePrefix: '05', title: 'Conclusion', state: 'upcoming', xp: 8 },
  ],
  'mod-7': [
    { id: 'l-7-1', moduleId: 'mod-7', number: '7.1', filePrefix: '01', title: 'Introduction', state: 'upcoming', xp: 8 },
    { id: 'l-7-2', moduleId: 'mod-7', number: '7.2', filePrefix: '02', title: 'Personal Safety', state: 'upcoming', xp: 10 },
    { id: 'l-7-3', moduleId: 'mod-7', number: '7.3', filePrefix: '03', title: 'Identifying Hazards', state: 'upcoming', xp: 10 },
    { id: 'l-7-4', moduleId: 'mod-7', number: '7.4', filePrefix: '04', title: 'Shift Work', state: 'upcoming', xp: 10 },
    { id: 'l-7-5', moduleId: 'mod-7', number: '7.5', filePrefix: '05', title: 'Conclusion', state: 'upcoming', xp: 8 },
  ],
}
