...
export function QuizCard({
  ...
  const stateStyles = {
    default: 'bg-navy-700 border-navy-600 hover:border-navy-500 hover:bg-navy-650',
    selected: 'bg-amber-500/10 border-amber-500',
    correct: 'bg-emerald-500 border-emerald-400 text-white',
    incorrect: 'bg-red-500 border-red-400 text-white',
    'correct-unselected': 'bg-navy-700 border-emerald-500',
  }

  const letterStyles = {
    default: 'bg-amber-500/20 text-amber-500',
    selected: 'bg-amber-500 text-navy-900',
    correct: 'bg-white/20 text-white',
    incorrect: 'bg-white/20 text-white',
    'correct-unselected': 'bg-emerald-500/20 text-emerald-500',
  }
  ...
  return (
    ...
    >
      ...
      <span
        className={cn(
          'text-base',
          state === 'correct' || state === 'incorrect' ? 'text-white' : 'text-white'
        )}
      >
        {text}
      </span>
