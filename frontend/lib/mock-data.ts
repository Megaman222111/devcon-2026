...
export const modules: ModuleData[] = [
  {
    ...
    completedLessons: lessonsForModule['mod-1'].length,
    scenariosCount: 1,
    estimatedMinutes: 50,
    locked: false,
  },
  {
    ...
    completedLessons: lessonsForModule['mod-2'].length,
    scenariosCount: 1,
    estimatedMinutes: 65,
    locked: false,
  },
  {
    ...
    completedLessons: lessonsForModule['mod-3'].length,
    scenariosCount: 1,
    estimatedMinutes: 90,
    locked: false,
  },
  {
    ...
    completedLessons: lessonsForModule['mod-4'].length,
    scenariosCount: 1,
    estimatedMinutes: 50,
    locked: false,
  },
  {
    ...
    completedLessons: lessonsForModule['mod-5'].length,
    scenariosCount: 1,
    estimatedMinutes: 45,
    locked: false,
  },
  {
    ...
    completedLessons: lessonsForModule['mod-6'].length,
    scenariosCount: 1,
    estimatedMinutes: 50,
    locked: false,
  },
  {
    ...
    completedLessons: lessonsForModule['mod-7'].length,
    scenariosCount: 1,
    estimatedMinutes: 40,
    locked: false,
  },
