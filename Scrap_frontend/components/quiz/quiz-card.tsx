...
export function QuizCard({
  ...
  const stateStyles = {
    default: 'bg-white border-navy-300 hover:border-amber-400',
    ...
    'correct-unselected': 'bg-emerald-50 border-emerald-500',
  }
  ...
  const letterStyles = {
    ...
    'correct-unselected': 'bg-emerald-200 text-emerald-700',
  }
